...
import TopNavigationAccount from "./TopNavigationAccount";
export default function TopNavigation() {
  return (
    <nav className="  sticky -top-1  backdrop-blur-md  z-20 border-b bg-secondary-870 border-secondary-870">
      <div className="container mx-auto h-[70px] xl:h-[90px] flex justify-between items-center  text-white">
        <div className=" flex items-center">
          ...
          <ul className="hidden xl:flex items-center whitespace-nowrap gap-8 ms-20">
            ...
            <li>
              <Link
                className="animate-underline animate-target pointer-events-none text-secondary-600"
                href="/courses"
              >
                مشاوره (به زودی)
              </Link>
